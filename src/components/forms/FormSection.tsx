...
const FormSection = ({ title, index, children }: FormSectionProps) => {
  return (
    <div className="rounded-[1.5rem] border border-white/5 bg-[#161616] p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden">
      ...
      <div className="relative flex items-center gap-4 pb-4 border-b border-white/10 z-10">
        <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[#F05B43] text-white text-sm font-bold shadow-[0_0_15px_rgba(240,91,67,0.4)]">
          {index}
        </span>
